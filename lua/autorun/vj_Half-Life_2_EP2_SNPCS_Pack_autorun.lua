------------------ Addon Information ------------------
local PublicAddonName = "Half-Life 2 EP2 SNPCS Pack"
local AddonName = "HL2 EP2"
local AddonType = "SNPC PACK"
...
if VJExists == true then
	...
	local vCat = "HL2 EP2" -- Category, you can also set a category individually by replacing the vCat with a string value
	VJ.AddNPC("Hunter", "npc_vj_rebelradio_hunter", vCat) -- Adds a NPC to the spawnmenu
	VJ.AddNPC_HUMAN("Combine Soldier", "npc_vj_rebelradio_combine", {"weapon_vj_smg1"}, vCat) -- Adds a NPC to the spawnmenu
	-- Parameters:
